...
const checks = [
  ...
  ["Observer plugin import", app.includes('import { Observer } from "gsap/Observer";') && app.includes("Observer.create") && app.includes("story-slider")],
  ...
  ["Observer swipe story deck", app.includes("function SwipeStoryDeck") && app.includes("storyIndex") && app.includes("goToStory") && app.includes("Swipe or scroll through common AI fixes.")],
  ...
  ["Observer swipe story CSS", css.includes(".story-slider") && css.includes(".story-slide.is-active") && css.includes(".story-progress-fill")],
