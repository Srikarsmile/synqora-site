...
const checks = [
  ...
  ["height-aware hero fit", css.includes("@media (max-height: 980px) and (min-width: 900px)") && css.includes("font-size: clamp(7.6rem, min(15.8vw, 21svh), 21rem)") && css.includes("min-height: min(780px, calc(100svh - 150px))")],
